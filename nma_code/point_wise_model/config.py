...
if DATA_MODE == 1:
    TRAIN_FILE = ['/users/lemonace/Downloads/multi-channel']
    VALID_FILE = TRAIN_FILE
    PREDICT_FILE = VALID_FILE
    TEST_FILE = PREDICT_FILE
elif DATA_MODE == 2:
    TRAIN_FILE = ['avito_v1_new/avito_v1_new/test_data/part-r-*']
    VALID_FILE = TRAIN_FILE
    TEST_FILE = VALID_FILE
elif DATA_MODE == 3:
    TRAIN_FILE = ["avito_v1_new/avito_v1_new/train_data/part-r-*"]
    VALID_FILE = ["avito_v1_new/avito_v1_new/test_data/part-r-*"]
    TEST_FILE= ["avito_v1_new/avito_v1_new/test_data/part-r-*"]
# 辅助脚本
